document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- Fungsi "New Chat" (SUDAH DIPERBAIKI) ---

    newChatBtn.addEventListener("click", (e) => {

        e.preventDefault();

        // Hapus hanya pesan, bukan seluruh isi kontainer

        const messages = chatContainer.querySelectorAll('.message, .loading-indicator');

        messages.forEach(msg => msg.remove());

        // Tampilkan kembali welcome screen yang masih ada di DOM
        ...
        conversationHistory = []; // Mengosongkan memori AI
    ...
    function appendMessage(role, text) {
        ...
        if (role !== 'user' && window.marked) {
            ...
            // Untuk user, gunakan textContent di dalam <p> agar aman dan konsisten
